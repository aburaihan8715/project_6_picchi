!(function (e) {
  ...
  function u(e, t) {
    m.ev.triggerHandler(x + e, t),
      m.st.callbacks && ((e = e.charAt(0).toLowerCase() + e.slice(1)), m.st.callbacks[e]) && m.st.callbacks[e].apply(m, Array.isArray(t) ? t : [t]);
  }
  function f(e) {
    return (
      (e === A && m.currTemplate.closeBtn) || ((m.currTemplate.closeBtn = c(m.st.closeMarkup.replace("%title%", m.st.tClose))), (A = e)),
        ...
        proto: (e.prototype = {
          ...
          init: function () {
            ...
            (m.isLowIE = m.isIE8 = document.all && !document.addEventListener),
              ...
              (m.probablyMobile =
                m.isAndroid || m.isIOS || /(Opera Mini)|Kindle|webOS|BlackBerry|(Opera Mobi)|(Windows Phone)|IEMobile/i.test(navigator.userAgent)),
              (g = c(document)),
              (m.popupsCache = {});
          },
          open: function (e) {
            ...
            if (!m.isOpen) {
              ...
              u("BeforeOpen"),
                ...
                m.fixedContentPos
                  ? m.wrap.css({ overflow: m.st.overflowY, overflowX: "hidden", overflowY: m.st.overflowY })
                  : m.wrap.css({ top: _.scrollTop(), position: "absolute" }),
                (!1 !== m.st.fixedBgPos && ("auto" !== m.st.fixedBgPos || m.fixedContentPos)) ||
          ...
          _close: function () {
            ...
            m.bgOverlay.detach(),
              ...
              m.fixedContentPos && ((e = { marginRight: "" }), m.isIE7 ? c("body, html").css("overflow", "") : (e.overflow = ""), c("html").css(e)),
          ...
          updateSize: function (e) {
            var t;
            m.isIOS
              ? ((t = document.documentElement.clientWidth / window.innerWidth), (t = window.innerHeight * t), m.wrap.css("height", t), (m.wH = t))
              : (m.wH = e || _.height()),
          ...
          updateItemHTML: function () {
            var e = m.items[m.index],
              ...
              n =
                ...
                (m.currItem = e),
                m.currTemplate[t] || ((n = !!m.st[t] && m.st[t].markup), u("FirstMarkupParse", n), (m.currTemplate[t] = !n || c(n))),
          ...
          addGroup: function (t, n) {
            ...
            ((n = n || {}).mainEl = t),
              n.items
                ...
                : ((n.isObj = !1), n.delegate ? t.off(o).on(o, n.delegate, e) : (n.items = t).off(o).on(o, e));
          },
          ...
          updateStatus: function (e, t) {
            ...
            m.preloader &&
              ...
              (n = { status: e, text: (t = t || "loading" !== e ? t : m.st.tLoading) }),
              u("UpdateStatus", n),
              (e = n.status),
              (t = n.text),
          ...
          "string" == typeof e
            ? "open" === e
              ? ((t = P ? i.data("magnificPopup") : i[0].magnificPopup),
                ...
                (o = t.items ? t.items[n] : ((o = i), (o = t.delegate ? o.find(t.delegate) : o).eq(n))),
                m._openClick({ mfpEl: o }, i, t))
              : m.isOpen && m[e].apply(m, Array.prototype.slice.call(arguments, 1))
            : ((e = c.extend(!0, {}, e)), P ? i.data("magnificPopup", e) : (i[0].magnificPopup = e), m.addGroup(i, e)),
          i
        );
      }),
      "inline"),
              ...
              e.src
                ? ((n = m.st.inline),
                  (o = c(e.src)).length
                    ? ((i = o[0].parentNode) &&
                        i.tagName &&
                        (v || ((l = n.hiddenClass), (v = p(l)), (l = "mfp-" + l)), (y = o.after(v).detach().removeClass(l))),
  ...
  c.magnificPopup.registerModule("image", {
    ...
    proto: {
      ...
      _onImageHasSize: function (e) {
        e.img &&
          ((e.hasSize = !0), z && clearInterval(z), (e.isCheckingImgSize = !1), u("ImageHasSize", e), e.imgHidden) &&
          (m.content && m.content.removeClass("mfp-loading"), (e.imgHidden = !1));
      },
      ...
      getImage: function (e, t) {
        function n() {
          e &&
            (e.img.off(".mfploader"),
            e === m.currItem && (m._onImageHasSize(e), m.updateStatus("error", a.tError.replace("%url%", e.src))),
            (e.hasSize = !0),
            (e.loaded = !0),
            (e.loadError = !0));
        }
        ...
        return (
          ...
          e.hasSize
            ? (z && clearInterval(z),
              e.loadError
                ? (t.addClass("mfp-loading"), m.updateStatus("error", a.tError.replace("%url%", e.src)))
    ...
    proto: {
      ...
      _getOffset: function (e) {
        var e = e ? m.currItem.img : m.st.zoom.opener(m.currItem.el || m.currItem),
          ...
          e = ((t.top -= c(window).scrollTop() - n), { width: e.width(), height: (P ? e.innerHeight() : e[0].offsetHeight) - o - n });
        return (
          (B = void 0 === B ? void 0 !== document.createElement("p").style.MozTransform : B)
            ? (e["-moz-transform"] = e.transform = "translate(" + t.left + "px," + t.top + "px)")
              ...
              i =
                (c.each(o.patterns, function () {
                  if (-1 < n.indexOf(this.index))
                    return (
                      this.id &&
                        (n = "string" == typeof this.id ? n.substr(n.lastIndexOf(this.id) + this.id.length, n.length) : this.id.call(this, n)),
      ...
      c.magnificPopup.registerModule("gallery", {
        ...
        proto: {
            ...
            r.langDir || (r.langDir = document.dir || "ltr"),
              ...
              d("BuildControls" + e, function () {
                ...
                1 < m.items.length &&
                  ...
                  "rtl" === r.langDir ? ((m.arrowNext = o), (m.arrowPrev = i)) : ((m.arrowNext = i), (m.arrowPrev = o)),
                  o.on("click", function () {
          ...
          preloadNearbyImages: function () {
            for (
              var e = m.st.gallery.preload, t = Math.min(e[0], m.items.length), n = Math.min(e[1], m.items.length), o = 1;
              o <= (m.direction ? n : t);
              o++
            )
          ...
          updateGalleryButtons: function () {
            m.st.gallery.loop ||
              ...
              null === m.arrowPrev ||
              (0 === m.index ? m.arrowPrev.hide() : m.arrowPrev.show(), m.index === m.items.length - 1 ? m.arrowNext.hide() : m.arrowNext.show());
          },
        },
      }),
      "retina");
